# Infrastructure code for "Serverless Application Architecture"
...
Infrastructure consists of multiple layers () where each layer is configured using one of [Terraform AWS modules](https://github.com/terraform-aws-modules/) with arguments specified in `terraform.tfvars` in layer's directory.
